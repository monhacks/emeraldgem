...
#define HELD_ITEMS_START FIRST_MAIL_INDEX
...
#define BERRIES_COUNT (LAST_BERRY_INDEX-FIRST_BERRY_INDEX)
...
#define ITEM_SYRUPY_APPLE 758
#define ITEM_GIGANTAMAX_STONE 759
