...
#define KANTO_DEX_START NATIONAL_DEX_BULBASAUR
#define JOHTO_DEX_START NATIONAL_DEX_CHIKORITA
#define HOENN_DEX_START NATIONAL_DEX_TREECKO
#define SINNOH_DEX_START NATIONAL_DEX_TURTWIG
#define UNOVA_DEX_START NATIONAL_DEX_VICTINI
#define KALOS_DEX_START NATIONAL_DEX_CHESPIN
#define ALOLA_DEX_START NATIONAL_DEX_ROWLET
#define GALAR_DEX_START NATIONAL_DEX_GROOKEY
