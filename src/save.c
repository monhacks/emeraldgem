...
STATIC_ASSERT(sizeof(struct SaveBlock2) <= SECTOR_DATA_SIZE + 64, SaveBlock2FreeSpace);
STATIC_ASSERT(sizeof(struct SaveBlock1) <= SECTOR_DATA_SIZE * (SECTOR_ID_SAVEBLOCK1_END - SECTOR_ID_SAVEBLOCK1_START + 64), SaveBlock1FreeSpace);
