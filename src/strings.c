...
const u8 gText_12PoofForgotMove[] = _("1, {PAUSE 15}2, y{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE SE_BALL_BOUNCE_1}¡Puf!\p{STR_VAR_1} olvidó cómo usar\n{STR_VAR_2}.\pY…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnRegainhedHealth[] = _("sin usar lol"); // Unused
