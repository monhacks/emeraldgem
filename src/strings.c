...
const u8 gText_UpdatingSaveExternalData[] = _("¡Te regalaron un {STR_VAR_1} y un {STR_VAR_2}!"); // Unused
const u8 gText_SaveFileUpdated[] = _("¡Has recibido un Regalo Misterioso!"); // Unused
...
const u8 gText_Player[] = _("¡Te regalaron un {STR_VAR_1}, un {STR_VAR_2} y un {STR_VAR_3}!"); // Unused
const u8 gText_Pokedex[] = _("¡Te regalaron un {STR_VAR_1}!"); // Unused
const u8 gText_Time[] = _("TIME");
const u8 gText_Badges[] = _("¡Te regalaron muchas cosas!"); // Unused
