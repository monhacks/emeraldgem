...
void CreateMonWithGenderNatureLetter(struct Pokemon *mon, u16 species, u8 level, u8 fixedIV, u8 gender, u8 nature, u8 unownLetter, u8 otIdType)
{
    ...
    if ((u8)(unownLetter - 1) < NUM_UNOWN_FORMS)
    {
        ...
        while (natures != GetNatureFromPersonality(personality)
...
// >>>>>>> e3b999705448cb6122b64da8f4c8829b761ca226
...
static void BufferStatRoseMessage(s32 arg0)
{
    ...
    if (B_X_ITEMS_BUFF >= GEN_7)
    {
        ...
        StringAppend(gBattleTextBuff2, sText_StatNOTRose);
		StringCopy(gBattleTextBuff2, gText_StatSharply);
    }
    else
    {
        StringCopy(gBattleTextBuff2, gText_StatRose);
        StringCopy(gBattleTextBuff2, sText_StatNOTRose);
    }
