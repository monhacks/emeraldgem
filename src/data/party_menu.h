...
} static const sCursorOptions[] =
{
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_ROCK_SMASH] = {gLongMoveNames[MOVE_ROCK_SMASH], CursorCb_FieldMove},
    ...
    [MENU_FIELD_MOVES + FIELD_MOVE_SECRET_POWER] = {gLongMoveNames[MOVE_SECRET_POWER], CursorCb_FieldMove},
...
{
    [ITEM_TM01 - ITEM_TM01] = MOVE_DRAIN_PUNCH, // changed, done
    [ITEM_TM02 - ITEM_TM01] = MOVE_DRAGON_CLAW,
    [ITEM_TM03 - ITEM_TM01] = MOVE_SCALD, // changed, done
    ...
    [ITEM_TM51 - ITEM_TM01] = MOVE_ROOST, // done
    [ITEM_TM52 - ITEM_TM01] = MOVE_ENERGY_BALL, // almost done
    [ITEM_TM53 - ITEM_TM01] = MOVE_FALSE_SWIPE, // done
    [ITEM_TM54 - ITEM_TM01] = MOVE_BRINE, // done
    [ITEM_TM55 - ITEM_TM01] = MOVE_CHARGE_BEAM, // done
    [ITEM_TM56 - ITEM_TM01] = MOVE_DRAGON_PULSE, // Todo
    [ITEM_TM57 - ITEM_TM01] = MOVE_WILL_O_WISP, // Done
    [ITEM_TM58 - ITEM_TM01] = MOVE_SHADOW_CLAW, // done
    [ITEM_TM59 - ITEM_TM01] = MOVE_ROCK_POLISH, // Todo
    [ITEM_TM60 - ITEM_TM01] = MOVE_STONE_EDGE, // done
    [ITEM_TM61 - ITEM_TM01] = MOVE_DARK_PULSE, // Todo
    [ITEM_TM62 - ITEM_TM01] = MOVE_ROCK_SLIDE, // done
    [ITEM_TM63 - ITEM_TM01] = MOVE_X_SCISSOR, // almost done
    [ITEM_TM64 - ITEM_TM01] = MOVE_SLEEP_TALK, // done
    [ITEM_TM65 - ITEM_TM01] = MOVE_POISON_JAB, // Todo
    [ITEM_TM66 - ITEM_TM01] = MOVE_GRASS_KNOT, // Todo
    [ITEM_TM67 - ITEM_TM01] = MOVE_SWAGGER, // Done
    [ITEM_TM68 - ITEM_TM01] = MOVE_PLUCK, // Done
    [ITEM_TM69 - ITEM_TM01] = MOVE_U_TURN, // Todo
    [ITEM_TM70 - ITEM_TM01] = MOVE_SUBSTITUTE, // done
    ...
    [ITEM_TM74 - ITEM_TM01] = MOVE_EARTH_POWER, // done
    [ITEM_TM75 - ITEM_TM01] = MOVE_FROST_BREATH, // almost done
    [ITEM_TM76 - ITEM_TM01] = MOVE_DRAGON_TAIL, // Todo
    [ITEM_TM77 - ITEM_TM01] = MOVE_WORK_UP, // almost done
    ...
    [ITEM_TM94 - ITEM_TM01] = MOVE_FIRE_FANG, // done
    [ITEM_TM95 - ITEM_TM01] = MOVE_ICE_FANG, // done
    [ITEM_TM96 - ITEM_TM01] = MOVE_THUNDER_FANG, // done
    [ITEM_TM97 - ITEM_TM01] = MOVE_SCREECH, // todo
    [ITEM_TM98 - ITEM_TM01] = MOVE_BREAKING_SWIPE, // Todo
    [ITEM_TM99 - ITEM_TM01] = MOVE_SPIRIT_BREAK, // done
    [ITEM_TM100 - ITEM_TM01] = MOVE_MISTY_EXPLOSION, // almost done
