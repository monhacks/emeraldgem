static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 23, 19},
    ...
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 6, 9},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), 16, 9},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(OLDALE_TOWN), MAP_NUM(OLDALE_TOWN), 8, 25},
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 8, 14},
    ...
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] = {MAP_GROUP(VERDANTURF_TOWN), MAP_NUM(VERDANTURF_TOWN), 43, 5},
    ...
    [HEAL_LOCATION_ROUTE110 - 1] = {MAP_GROUP(ROUTE110), MAP_NUM(ROUTE110), 10, 66},
    [HEAL_LOCATION_ROUTE111 - 1] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), 26, 19},
    [HEAL_LOCATION_ROUTE119 - 1] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), 33, 110},
    [HEAL_LOCATION_ROUTE121 - 1] = {MAP_GROUP(ROUTE121), MAP_NUM(ROUTE121), 37, 6},
};
