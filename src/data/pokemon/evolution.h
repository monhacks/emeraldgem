const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_RHYDON]                = {{EVO_TRADE_ITEM, ITEM_PROTECTOR, SPECIES_RHYPERIOR},
                                       {EVO_ITEM_HOLD_DAY, ITEM_PROTECTOR, SPECIES_RHYPERIOR}},
    ...
    [SPECIES_PORYGON]               = {{EVO_TRADE_ITEM, ITEM_UPGRADE, SPECIES_PORYGON2},
                                       {EVO_ITEM_HOLD_DAY, ITEM_UPGRADE, SPECIES_PORYGON2}},
    ...
    [SPECIES_SUNKERN]               = {{EVO_MOVE, MOVE_EMBER, SPECIES_SUNFLORA}},
    ...
    [SPECIES_DUNSPARCE]                = {{EVO_MOVE, MOVE_HYPERDRILL, SPECIES_DUDUNSPARCE}},
    ...
    [SPECIES_URSARING]             = {{EVO_LEVEL_NIGHT, 38, SPECIES_URSALUNA}},
	...
	[SPECIES_LUVDISC]				= {{EVO_MOVE, MOVE_HEAL_PULSE, SPECIES_ALOMOMOLA}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                                       ...
                                       {EVO_ITEM_HOLD_DAY, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
										{EVO_MOVE_TYPE, TYPE_ICE, SPECIES_MR_MIME_GALARIAN},
										},
    ...
    [SPECIES_HIPPOPOTAS]            = {{EVO_LEVEL, 28, SPECIES_HIPPOWDON}},
    [SPECIES_SKORUPI]               = {{EVO_LEVEL, 29, SPECIES_DRAPION}},
    ...
    [SPECIES_TIMBURR]               = {{EVO_LEVEL, 18, SPECIES_GURDURR}},
    [SPECIES_GURDURR]               = {{EVO_TRADE, 0, SPECIES_CONKELDURR},
									   {EVO_LEVEL, 36, SPECIES_CONKELDURR}},
    [SPECIES_TYMPOLE]               = {{EVO_LEVEL, 22, SPECIES_PALPITOAD}},
    ...
    [SPECIES_KROKOROK]              = {{EVO_LEVEL, 30, SPECIES_KROOKODILE}},
    [SPECIES_DARUMAKA]              = {{EVO_LEVEL, 25, SPECIES_DARMANITAN}},
    [SPECIES_DWEBBLE]               = {{EVO_LEVEL, 18, SPECIES_CRUSTLE}},
    [SPECIES_SCRAGGY]               = {{EVO_LEVEL_NIGHT, 22, SPECIES_SCRAFTY}},
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 28, SPECIES_COFAGRIGUS}},
    [SPECIES_TIRTOUGA]              = {{EVO_LEVEL, 28, SPECIES_CARRACOSTA}},
    [SPECIES_ARCHEN]                = {{EVO_LEVEL, 28, SPECIES_ARCHEOPS}},
    [SPECIES_TRUBBISH]              = {{EVO_LEVEL, 24, SPECIES_GARBODOR}},
    ...
    [SPECIES_GOTHORITA]             = {{EVO_LEVEL, 33, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]               = {{EVO_LEVEL, 16, SPECIES_DUOSION}},
    [SPECIES_DUOSION]               = {{EVO_LEVEL, 32, SPECIES_REUNICLUS}},
    [SPECIES_DUCKLETT]              = {{EVO_LEVEL, 18, SPECIES_SWANNA}},
    [SPECIES_VANILLITE]             = {{EVO_LEVEL, 16, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]             = {{EVO_LEVEL, 32, SPECIES_VANILLUXE}},
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 24, SPECIES_SAWSBUCK}},
    ...
    [SPECIES_FOONGUS]               = {{EVO_LEVEL, 29, SPECIES_AMOONGUSS}},
    [SPECIES_FRILLISH]              = {{EVO_LEVEL, 28, SPECIES_JELLICENT}},
    [SPECIES_JOLTIK]                = {{EVO_LEVEL, 36, SPECIES_GALVANTULA}},
    [SPECIES_FERROSEED]             = {{EVO_LEVEL, 40, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 15, SPECIES_KLANG}},
    [SPECIES_KLANG]                 = {{EVO_LEVEL, 38, SPECIES_KLINKLANG}},
    [SPECIES_TYNAMO]                = {{EVO_LEVEL, 22, SPECIES_EELEKTRIK}},
    ...
    [SPECIES_AXEW]                  = {{EVO_LEVEL, 20, SPECIES_FRAXURE}},
    [SPECIES_FRAXURE]               = {{EVO_LEVEL, 36, SPECIES_HAXORUS}},
    [SPECIES_CUBCHOO]               = {{EVO_LEVEL, 20, SPECIES_BEARTIC}},
    ...
    [SPECIES_MIENFOO]               = {{EVO_LEVEL, 25, SPECIES_MIENSHAO}},
    [SPECIES_GOLETT]                = {{EVO_LEVEL, 28, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]              = {{EVO_LEVEL, 30, SPECIES_BISHARP}},
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 24, SPECIES_BRAVIARY}},
    [SPECIES_VULLABY]               = {{EVO_LEVEL, 24, SPECIES_MANDIBUZZ}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_TRADE_ITEM, ITEM_SACHET, SPECIES_AROMATISSE},
									   ...
									   {EVO_ITEM_HOLD_DAY, ITEM_SACHET, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_TRADE_ITEM, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF},
									   {EVO_ITEM_HOLD_DAY, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF},
    ...
    [SPECIES_SKRELP]                = {{EVO_LEVEL, 42, SPECIES_DRAGALGE}},
    [SPECIES_CLAUNCHER]             = {{EVO_LEVEL, 37, SPECIES_CLAWITZER}},
    [SPECIES_HELIOPTILE]            = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_HELIOLISK}},
    [SPECIES_TYRUNT]                = {{EVO_LEVEL_DAY, 33, SPECIES_TYRANTRUM}},
    [SPECIES_AMAURA]                = {{EVO_LEVEL_NIGHT, 33, SPECIES_AURORUS}},
    ...
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 42, SPECIES_NOIVERN}},
    ...
    [SPECIES_SANDYGAST]             = {{EVO_LEVEL, 38, SPECIES_PALOSSAND}},
    ...
    [SPECIES_RILLABOOM]             = {{EVO_MEGA_EVOLUTION, ITEM_GIGANTAMAX_STONE, SPECIES_RILLABOOM_GIGANTAMAX}},
    [SPECIES_SCORBUNNY]             = {{EVO_LEVEL, 16, SPECIES_RABOOT}},
    [SPECIES_RABOOT]                = {{EVO_LEVEL, 35, SPECIES_CINDERACE}},
    [SPECIES_CINDERACE]             = {{EVO_MEGA_EVOLUTION, ITEM_GIGANTAMAX_STONE, SPECIES_CINDERACE_GIGANTAMAX}},
    [SPECIES_SOBBLE]                = {{EVO_LEVEL, 16, SPECIES_DRIZZILE}},
    [SPECIES_DRIZZILE]              = {{EVO_LEVEL, 35, SPECIES_INTELEON}},
    [SPECIES_INTELEON]              = {{EVO_MEGA_EVOLUTION, ITEM_GIGANTAMAX_STONE, SPECIES_INTELEON_GIGANTAMAX}},
    ...
    [SPECIES_MILCERY]               = {{EVO_ITEM_HOLD_DAY, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE},
                                       {EVO_ITEM_HOLD_DAY, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_RUBY_CREAM},
                                       {EVO_ITEM_HOLD_DAY, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_MATCHA_CREAM},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_MINT_CREAM},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_STAR_SWEET, SPECIES_ALCREMIE_LEMON_CREAM},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_RIBBON_SWEET, SPECIES_ALCREMIE_SALTED_CREAM},
                                       {EVO_ITEM_HOLD_DAY, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_RUBY_SWIRL},
                                       {EVO_ITEM_HOLD_DAY, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_CARAMEL_SWIRL},
                                       {EVO_LEVEL_DUSK, 1, SPECIES_ALCREMIE_RAINBOW_SWIRL}},
	...
	[SPECIES_RITTO]					= {{EVO_MOVE, MOVE_CURSE, SPECIES_RIDDUAL}},
    ...
    [SPECIES_DEERLING_SUMMER]       = {{EVO_LEVEL, 24, SPECIES_SAWSBUCK_SUMMER}},
    [SPECIES_DEERLING_AUTUMN]       = {{EVO_LEVEL, 24, SPECIES_SAWSBUCK_AUTUMN}},
    [SPECIES_DEERLING_WINTER]       = {{EVO_LEVEL, 24, SPECIES_SAWSBUCK_WINTER}},
