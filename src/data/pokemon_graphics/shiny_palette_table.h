const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(RIDDUAL, gMonShinyPalette_Riddual),
    SPECIES_SHINY_PAL(RITTO, gMonShinyPalette_Ritto),
	...
	SPECIES_SHINY_PAL(ROWLET_ASH, gMonShinyPalette_RowletAsh),
#endif
    SPECIES_SHINY_PAL(EGG, gMonPalette_EggShiny),
};
