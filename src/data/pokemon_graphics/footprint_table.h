const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_RITTO] = gMonFootprint_Ditto,
    [SPECIES_RIDDUAL] = gMonFootprint_Ditto,
    ...
    [SPECIES_DIPPLIN] = gMonFootprint_Applin,
