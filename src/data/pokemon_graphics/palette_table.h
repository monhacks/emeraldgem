const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(RIDDUAL, gMonPalette_Riddual),
    SPECIES_PAL(RITTO, gMonPalette_Ritto),
	...
	SPECIES_PAL(ROWLET_ASH, gMonPalette_RowletAsh),
#endif
    SPECIES_PAL(EGG, gMonPalette_Egg),
};
const struct CompressedSpritePalette gEggOldGensPaletteTable[] =
{
	SPECIES_PAL(EGG, gMonPalette_EggOldGens),
};
