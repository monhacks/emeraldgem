const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LUCKY_CHANT] = _("CánticoSuerte"),
    ...
    [MOVE_LAST_RESORT] = _("ÚltimoRecurso"),
    ...
    [MOVE_FORCE_PALM] = _("FuerzaDePalma"),
    ...
    [MOVE_FLASH_CANNON] = _("CañónDestello"),
    ...
    [MOVE_LEAF_STORM] = _("TormentaHojas"),
