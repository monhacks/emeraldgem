...
static const u8 sPremierBallDesc[] = _(
    "Made to celebrate\none that goes prepared.");

static const u8 sHealBallDesc[] = _(
    "Heals the caught Pokémon.");

static const u8 sNetBallDesc[] = _(
    "Catches Bug- and Water-types.");

static const u8 sNestBallDesc[] = _(
    "Catches low-level Pokémon.");

static const u8 sDiveBallDesc[] = _(
    "Catches underwater Pokémon.");

static const u8 sDuskBallDesc[] = _(
    "Catches Pokémon in the dark.");

static const u8 sTimerBallDesc[] = _(
    "Batter the longer\na Battle lasts.");

static const u8 sQuickBallDesc[] = _(
    "Better in the first turn.");

static const u8 sRepeatBallDesc[] = _(
    "Better in already caught\nPokémon.");

static const u8 sLuxuryBallDesc[] = _(
    "Boosts friendship gain.");

static const u8 sLevelBallDesc[] = _(
    "Catches lower level Pokémon.");

static const u8 sLureBallDesc[] = _(
    "Catches fished up Pokémon.");

static const u8 sMoonBallDesc[] = _(
    "Catches Pokémon that evolve\nvia Moon Stone,\nnot Burn Heal.");

static const u8 sFriendBallDesc[] = _(
    "Befriends caught Pokémon.");

static const u8 sLoveBallDesc[] = _(
    "Catches same-species Pokémon.");

static const u8 sFastBallDesc[] = _(
    "Fast Pokémon love it.");

static const u8 sHeavyBallDesc[] = _(
    "Only catches heavy Pokémon.");

static const u8 sDreamBallDesc[] = _(
    "Catches asleep Pokémon.");

static const u8 sSafariBallDesc[] = _(
    "Just like an Ultra Ball.");
