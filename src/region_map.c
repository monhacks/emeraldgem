...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_ROUTE_104_NORTH] = {MAP_GROUP(ROUTE104), MAP_NUM(ROUTE104), 0},
...
static u8 GetMapsecType(u16 mapSecId)
{
	...
	case MAPSEC_ROUTE_110:
		return (FlagGet(FLAG_VISITED_SLATEPORT_CITY) && FlagGet(FLAG_VISITED_MAUVILLE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_111:
		return (FlagGet(FLAG_VISITED_FALLARBOR_TOWN) && FlagGet(FLAG_VISITED_MAUVILLE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_119:
		return (FlagGet(FLAG_VISITED_FORTREE_CITY) && FlagGet(FLAG_VISITED_MAUVILLE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_121:
		return (FlagGet(FLAG_VISITED_LILYCOVE_CITY) && FlagGet(FLAG_VISITED_FORTREE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_112:
		return (FlagGet(FLAG_HIDE_ROUTE_112_TEAM_MAGMA) && FlagGet(FLAG_VISITED_MAUVILLE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_113:
		return (FlagGet(FLAG_VISITED_FALLARBOR_TOWN) && FlagGet(FLAG_VISITED_MAUVILLE_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_125:
		return (FlagGet(FLAG_VISITED_MOSSDEEP_CITY)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
	case MAPSEC_ROUTE_108:
		return (FlagGet(FLAG_RECEIVED_HM04)) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_ROUTE;
