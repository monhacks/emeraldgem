...
static const u16 sShopInventory3_One[] = {
    ITEM_ORAN_BERRY,
    ITEM_PECHA_BERRY,
    ITEM_CHERI_BERRY,
    ITEM_CHESTO_BERRY,
...
static const u16 sShopInventory3_Two[] = {
    ITEM_ORAN_BERRY,
    ITEM_PECHA_BERRY,
    ITEM_CHERI_BERRY,
    ITEM_CHESTO_BERRY,
...
static const u16 sShopInventory3_Three[] = {
    ITEM_ORAN_BERRY,
    ITEM_PECHA_BERRY,
    ITEM_CHERI_BERRY,
    ITEM_CHESTO_BERRY,
...
static const u16 sShopInventory3_Four[] = {
    ITEM_ORAN_BERRY,
    ITEM_PECHA_BERRY,
    ITEM_CHERI_BERRY,
    ITEM_CHESTO_BERRY,
...
static const u16 *const sShopInventories3[] = 
{
    sShopInventory3_One, 
    sShopInventory3_One,
    sShopInventory3_Two,
    sShopInventory3_Two,
    sShopInventory3_Three,
    sShopInventory3_Four,
    sShopInventory3_Four,
    sShopInventory3_Four,
    sShopInventory3_Four
};
...
static void SetShopItemsForSale(const u16 *items)
{
    ...
    if (items == NULL) {
		if (FlagGet(FLAG_SECONDMART)) 
			sMartInfo.itemList = sShopInventories2[badgeCount];
		else if (FlagGet(FLAG_BAYASMART)) 
			sMartInfo.itemList = sShopInventories3[badgeCount];
		else 
