...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_RITTO] = gMonIcon_Ritto,
    [SPECIES_RIDDUAL] = gMonIcon_Riddual,
    ...
    [SPECIES_ROWLET_ASH] = gMonIcon_RowletAsh,
    ...
    [SPECIES_RILLABOOM_GIGANTAMAX] = gMonIcon_Rillaboom,
    [SPECIES_CINDERACE_GIGANTAMAX] = gMonIcon_Cinderace,
    [SPECIES_INTELEON_GIGANTAMAX] = gMonIcon_Inteleon,
