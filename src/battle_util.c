...
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic ice     dragon  dark    fairy
    {______, ______, ______, ______, ______, X(0.5), ______, X(0.0), X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______}, // normal
    {X(2.0), ______, X(0.5), X(0.5), ______, X(2.0), X(0.5), X(0.0), X(2.0), X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), X(0.5)}, // fight
    {______, X(2.0), ______, ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, X(0.5), ______, ______, ______}, // flying
    {______, ______, ______, X(0.5), X(0.5), X(0.5), X(0.0), X(0.5), X(0.0), X(2.0), ______, ______, X(2.0), ______, ______, ______, ______, ______, X(2.0)}, // poison
    {______, ______, X(0.0), X(2.0), ______, X(2.0), X(0.5), ______, X(2.0), ______, X(2.0), ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______}, // ground
    {______, X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, ______, ______, X(2.0), ______, ______, ______}, // rock
    {______, X(0.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), X(0.5), X(2.0), X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(2.0)}, // bug
    #if B_STEEL_RESISTANCES >= GEN_6
    {X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______}, // ghost
    #else
    {X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______}, // ghost
    #endif
    {______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(2.0), X(0.5), X(0.5), ______, X(0.5), ______, X(2.0), ______, ______, X(2.0)}, // steel
    {______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______}, // mystery
    {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, ______}, // fire
    {______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______}, // water
    {______, ______, X(0.5), X(0.5), X(2.0), X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______}, // grass
    {______, ______, X(2.0), ______, X(0.0), ______, ______, ______, X(2.0), ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______}, // electric
    {______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______}, // psychic
    {______, ______, X(2.0), ______, X(2.0), ______, ______, ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______}, // ice
    {______, ______, ______, ______, ______, ______, ______, ______, X(0.5), X(0.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(0.0)}, // dragon
    #if B_STEEL_RESISTANCES >= GEN_6
    {______, X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5)}, // dark
    #else
    {______, X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), X(0.5), X(0.5), ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5)}, // dark
    #endif
    {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______}, // fairy
};

static const u16 sInverseTypeEffectivenessTable[NUMBER_OF_MON_TYPES][NUMBER_OF_MON_TYPES] =
{
//   normal  fight   flying  poison  ground  rock    bug     ghost   steel   mystery fire    water   grass  electric psychic ice     dragon  dark    fairy
    {______, ______, ______, ______, ______, X(2.0), ______, X(2.0), X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______}, // normal
    {X(0.5), ______, X(2.0), X(2.0), ______, X(0.5), X(2.0), X(2.0), X(0.5), X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), ______, X(0.5), X(2.0)}, // fight
    {______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, X(2.0), ______, ______, ______, X(0.5), X(2.0), ______, X(2.0), ______, ______, ______}, // flying
    {______, ______, ______, X(2.0), X(2.0), X(2.0), ______, X(2.0), X(2.0), X(0.5), ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5)}, // poison
    {______, ______, X(2.0), X(0.5), ______, X(0.5), X(2.0), ______, X(0.5), ______, X(0.5), ______, X(2.0), X(0.5), ______, X(2.0), ______, ______, ______}, // ground
    {______, X(2.0), X(0.5), ______, X(2.0), ______, X(0.5), ______, X(2.0), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, ______, ______}, // rock
    {______, X(2.0), X(2.0), X(2.0), ______, ______, ______, X(2.0), X(2.0), X(0.5), X(2.0), ______, X(0.5), ______, X(0.5), ______, ______, X(0.5), X(0.5)}, // bug
    #if B_STEEL_RESISTANCES >= GEN_6
    {X(2.0), ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), ______}, // ghost
    #else
    {X(2.0), ______, ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), ______}, // ghost
    #endif
    {______, ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), X(0.5), X(2.0), X(2.0), ______, X(2.0), ______, X(0.5), ______, ______, X(0.5)}, // steel
    {______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______}, // mystery
    {______, ______, ______, ______, ______, X(2.0), X(0.5), ______, X(0.5), ______, X(2.0), X(2.0), X(0.5), ______, ______, X(0.5), X(2.0), ______, ______}, // fire
    {______, ______, ______, ______, X(0.5), X(0.5), ______, ______, ______, ______, X(0.5), X(2.0), X(2.0), ______, ______, X(2.0), X(2.0), ______, ______}, // water
    {______, ______, X(2.0), X(2.0), X(0.5), X(0.5), X(2.0), ______, X(2.0), ______, X(2.0), X(0.5), X(2.0), ______, ______, X(2.0), X(2.0), ______, ______}, // grass
    {______, ______, X(0.5), ______, X(2.0), ______, ______, ______, X(0.5), ______, ______, X(0.5), X(2.0), X(2.0), ______, ______, X(2.0), ______, ______}, // electric
    {______, X(0.5), ______, X(0.5), ______, ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, ______, X(2.0), ______, ______, X(2.0), ______}, // psychic
    {______, ______, X(0.5), ______, X(0.5), ______, ______, ______, X(2.0), ______, X(2.0), X(2.0), X(0.5), ______, ______, X(2.0), X(0.5), ______, ______}, // ice
    {______, ______, ______, ______, ______, ______, ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, ______, X(0.0), X(0.5), ______, X(2.0)}, // dragon
    #if B_STEEL_RESISTANCES >= GEN_6
    {______, X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), ______, X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), X(2.0)}, // dark
    #else
    {______, X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(2.0), X(2.0), ______, ______, ______, ______, X(0.5), ______, ______, X(2.0), X(2.0)}, // dark
    #endif
    {______, X(0.5), ______, X(2.0), ______, ______, X(2.0), ______, X(2.0), ______, X(2.0), ______, ______, ______, ______, ______, X(0.5), X(0.5), ______}, // fairy
};
...
void CancelMultiTurnMoves(u8 battler)
{
    ...
    if (gBattleStruct->skyDropTargets[battler] != 0xFF && !(gStatuses3[battler] & STATUS3_SKY_DROPPED))
    {
        ...
        if (gBattleMons[otherSkyDropper].status2 & STATUS2_LOCK_CONFUSE && gBattleStruct->turnEffectsTracker != 24 /*&& !IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_BUG)*/)
        {
...
u8 DoBattlerEndTurnEffects(void)
{
    ...
    while (gBattleStruct->turnEffectsBattlerId < gBattlersCount && gBattleStruct->turnEffectsTracker <= ENDTURN_BATTLER_COUNT)
    {
        ...
        case ENDTURN_THRASH:  // thrash
            ...
            if (gBattleMons[gActiveBattler].status2 & STATUS2_LOCK_CONFUSE && !(gStatuses3[gActiveBattler] & STATUS3_SKY_DROPPED) /*&& !IS_BATTLER_OF_TYPE(gBattlerAttacker, TYPE_BUG)*/)
            {
                ...
                {
                    gBattleMons[gActiveBattler].status2 &= ~STATUS2_MULTIPLETURNS;
                    if (!(gBattleMons[gActiveBattler].status2 & STATUS2_CONFUSION) && !IS_BATTLER_OF_TYPE(gActiveBattler, TYPE_BUG))
                    {
...
u8 AtkCanceller_UnableToUseMove(void)
{
    ...
    } while (gBattleStruct->atkCancellerTracker != CANCELLER_END && gBattleStruct->atkCancellerTracker != CANCELLER_FROZEN && gBattleStruct->atkCancellerTracker != CANCELLER_END2 && effect == 0);
