...
static const u8 sTileBitAttributes[NUM_METATILE_BEHAVIORS] =
{
    ...
    [MB_ICE_2]                           = TILE_FLAG_UNUSED,
    [MB_ICE_SWITCH]                      = TILE_FLAG_UNUSED,
	...
	[MB_TRADE_SELF]						 = TILE_FLAG_UNUSED,
    [MB_TRADE_SELF_2]					 = TILE_FLAG_UNUSED,
...
bool8 MetatileBehavior_IsIce_3(u8 metatileBehavior)
{
    if (metatileBehavior == MB_ICE_2)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsIce_Switch(u8 metatileBehavior)
{
    if (metatileBehavior == MB_ICE_SWITCH)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsSpecialDoor(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SPECIAL_DOOR)
        return TRUE;
    else
        return FALSE;
}
