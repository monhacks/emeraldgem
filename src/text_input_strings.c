...
const u8 gText_NamingScreenKeyboard_mnopqrs[] = _("{CLEAR 11}m{CLEAR 6}n{CLEAR 6}o{CLEAR 26}p{CLEAR 6}q{CLEAR 7}r{CLEAR 6}s{CLEAR 27}ñ");
...
const u8 gText_NamingScreenKeyboard_MNOPQRS[] = _("{CLEAR 11}M{CLEAR 6}N{CLEAR 6}O{CLEAR 26}P{CLEAR 6}Q{CLEAR 6}R{CLEAR 6}S{CLEAR 26}Ñ");
const u8 gText_NamingScreenKeyboard_TUVWXYZ[] = _("{CLEAR 11}T{CLEAR 6}U{CLEAR 6}V{CLEAR 26}W{CLEAR 6}X{CLEAR 6}Y{CLEAR 6}Z{CLEAR 26} ");
const u8 gText_NamingScreenKeyboard_01234[] = _("{CLEAR 11}0{CLEAR 6}1{CLEAR 6}2{CLEAR 26}3{CLEAR 6}4{CLEAR 6}5{CLEAR 6}6{CLEAR 30} ");
const u8 gText_NamingScreenKeyboard_56789[] = _("{CLEAR 11}7{CLEAR 6}8{CLEAR 6}9{CLEAR 27}¡{CLEAR 7}¿{CLEAR 7}!{CLEAR 7}?{CLEAR 30} ");
const u8 gText_NamingScreenKeyboard_Symbols1[] = _("{CLEAR 11}♂{CLEAR 6}♀{CLEAR 7}…{CLEAR 26}“{CLEAR 6}”{CLEAR 6}‘{CLEAR 7}'{CLEAR 30} ");
const u8 gText_NamingScreenKeyboard_Symbols2[] = _("{CLEAR 11}/{CLEAR 7}-{CLEAR 6}á{CLEAR 25}é{CLEAR 6}í{CLEAR 7}ó{CLEAR 6}ú{CLEAR 26}ü");
...
const u8 gText_UnionRoomChatKeyboard_Z[] = _("YZ   ");
